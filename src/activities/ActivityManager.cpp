...
#include "network/AgentVoiceActivity.h"
...
void ActivityManager::goToVoiceMenu(int tab) {
  replaceActivity(std::make_unique<VoiceMenuActivity>(renderer, mappedInput, static_cast<VoiceMenuActivity::Tab>(tab)));
}
